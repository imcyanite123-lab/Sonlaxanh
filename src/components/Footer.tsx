import { Facebook, Instagram, Mail, Phone, Heart, Leaf } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=61587108442989" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-2xl bg-white border border-slate-100 flex items-center justify-center text-slate-400 hover:bg-green-600 hover:text-white transition-all shadow-sm">
                <Facebook size={24} />
              </a>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex gap-8 text-[10px] font-bold tracking-widest text-slate-400 uppercase">
            <span>FACEBOOK / SON LA XANH</span>
            <span>EMAIL / SONLAXANHCONTACT@GMAIL.COM</span>
          </div>
